...
const Statistics = () => {
  return (
    <div>
      <div className="flex w-full justify-around  gap-2 flex-wrap ">
...
const FourBoxFirst = ({ title, value, percent, data }) => {
  ...
  return (
    <div className="lg:w-1/4 flex-wrap  shadow-xl bg-white py-3 px-2 rounded-lg">
      <h5 className="text-gray-600 capitalize text-lg font-semibold">
        {title}
      </h5>
      <div className="flex-col">
        <div className="flex gap-3 items-center">
          <span className="font-bold whitespace-nowrap text-xl">{formatMoneyVietNam(value)} $</span>
          ...
          <div
            className={`${
              percent >= 70
                ...
                ? "bg-green-500"
                : "bg-orange-500"
            } px-3 py-1 rounded-lg items-center text-white flex gap-2 whitespace-nowrap`}
          >
            <i className="text-lg ">
